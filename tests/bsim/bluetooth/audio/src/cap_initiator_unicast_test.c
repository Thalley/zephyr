...
CREATE_FLAG(flag_subproc_start_codec_configured);
CREATE_FLAG(flag_subproc_start_qos_configured);
CREATE_FLAG(flag_subproc_start_enabled);
CREATE_FLAG(flag_subproc_start_connected);
CREATE_FLAG(flag_subproc_start_started);
CREATE_FLAG(flag_updated);
CREATE_FLAG(flag_stopped);
CREATE_FLAG(flag_subproc_stop_disabled);
CREATE_FLAG(flag_subproc_stop_stopped);
CREATE_FLAG(flag_subproc_stop_released);
...
static void unicast_start_codec_configured_cb(void)
{
	...
	SET_FLAG(flag_subproc_start_codec_configured);
}
...
static void unicast_start_qos_configured_cb(void)
{
	...
	SET_FLAG(flag_subproc_start_qos_configured);
}
...
static void unicast_start_enabled_cb(void)
{
	...
	SET_FLAG(flag_subproc_start_enabled);
}
...
static void unicast_start_connected_cb(void)
{
	...
	SET_FLAG(flag_subproc_start_connected);
}
...
static void unicast_start_started_cb(void)
{
	...
	SET_FLAG(flag_subproc_start_started);
}
...
static void unicast_stop_disabled_cb(void)
{
	...
	SET_FLAG(flag_subproc_stop_disabled);
}
...
static void unicast_stop_stopped_cb(void)
{
	...
	SET_FLAG(flag_subproc_stop_stopped);
}
...
static void unicast_stop_released_cb(void)
{
	...
	SET_FLAG(flag_subproc_stop_released);
}
...
static void unicast_audio_start(struct bt_cap_unicast_group *unicast_group, bool wait)
{
	...
	UNSET_FLAG(flag_subproc_start_codec_configured);
	UNSET_FLAG(flag_subproc_start_qos_configured);
	UNSET_FLAG(flag_subproc_start_enabled);
	UNSET_FLAG(flag_subproc_start_connected);
	UNSET_FLAG(flag_subproc_start_started);
	...
	if (wait) {
		 ...
		 * performed
		 */
		WAIT_FOR_FLAG(flag_subproc_start_codec_configured);
		WAIT_FOR_FLAG(flag_subproc_start_qos_configured);
		WAIT_FOR_FLAG(flag_subproc_start_enabled);
		WAIT_FOR_FLAG(flag_subproc_start_connected);
		WAIT_FOR_FLAG(flag_subproc_start_started);
...
static void cap_initiator_unicast_audio_stop(struct bt_cap_unicast_group *unicast_group)
{
	...
	UNSET_FLAG(flag_subproc_stop_disabled);
	UNSET_FLAG(flag_subproc_stop_stopped);
	UNSET_FLAG(flag_subproc_stop_released);
	 ...
	 */
	WAIT_FOR_FLAG(flag_subproc_stop_disabled);
	WAIT_FOR_FLAG(flag_subproc_stop_stopped);
	if (TEST_FLAG(flag_subproc_stop_released)) {
	 ...
	 */
	WAIT_FOR_FLAG(flag_subproc_stop_released);
	if (TEST_FLAG(flag_subproc_stop_disabled) || TEST_FLAG(flag_subproc_stop_stopped)) {
