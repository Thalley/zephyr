/* main.c - Advertising set SID tests */
 ...
 */
#define UNHANDLED_CMD_RP_SIZE 64
...
static const struct cmd_handler cmds[] = {
	...
	{BT_HCI_OP_LE_READ_SUPP_STATES, sizeof(struct bt_hci_rp_le_read_supp_states),
	 le_read_supp_states},
	{BT_HCI_OP_LE_READ_MAX_ADV_DATA_LEN, sizeof(struct bt_hci_rp_le_read_max_adv_data_len),
	 le_read_max_adv_data_len},
	{BT_HCI_OP_LE_SET_EXT_ADV_PARAM, sizeof(struct bt_hci_rp_le_set_ext_adv_param),
...
ZTEST(bt_adv_sid, test_ext_adv_uses_param_sid)
{
...
ZTEST(bt_adv_sid, test_legacy_adv_sid_is_invalid)
{
	struct bt_le_adv_param param = adv_param_get(5U, false);
	struct bt_le_ext_adv *adv;
	int err;
...
ZTEST(bt_adv_sid, test_ext_adv_invalid_sid_rejected)
{
...
ZTEST(bt_adv_sid, test_update_param_updates_sid)
{
