...
Starts by scanning for a CAP Acceptor and then sets up unicast audio, and then switches between
unicast and broadcast using the CAP handover procedures.
...
.. zephyr-app-commands::
   :zephyr-app: samples/bluetooth/audio/cap_handover/
